FROM registry.access.redhat.com/ubi9/go-toolset:1.26.4-1783442369 AS git-builder
...
FROM registry.access.redhat.com/ubi9/go-toolset:1.26.4-1783442369 AS slsa-builder
